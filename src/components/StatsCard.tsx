...
const StatsCard = ({ data }: { data: StatsCardProps }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 ">
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Total Connections </p>
      ...
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Created Clubs</p>
      ...
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Club Member</p>
      ...
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Connection Requests</p>
      ...
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Pending Notifications</p>
              <p className="text-2xl font-bold">
      ...
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Jobs Applied</p>
              <p className="text-2xl font-bold">
                {data.unreadNotificationsCount}
              </p>
            </div>
      ...
      <Card className="dark:bg-zinc-800/50 border-zinc-700/50 hover:bg-zinc-800/80 transition-colors">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm dark:text-zinc-400">Events Scheduled</p>
              <p className="text-2xl font-bold">
